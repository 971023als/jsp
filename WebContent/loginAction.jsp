  ...
  <nav class="navbar navbar-default">
    	...
    	<ul class="nav navbar-nav navbar-right">
    	 ...
    	 <ul class="dropdown-menu">
  			...
  			aria-expanded="false">로그인 완료<span class="caret"></span></a>
   		<ul class= "dropdown-menu">
  ...
  <div class="col-lg-4">
   <div class="jumbotron" style="padding-top: 50px;margin-top: 50px;">
    <form method="post" action="loginAction.jsp">
     <h3 style="text-align: center;">로그인 되었습니다</h3>
    <%
    ...
    <div class="form-group">
      ...
      <input type="button" class="btn btn-primary form-control" value="뒤로 가기" OnClick="location='login.jsp'">
    </form>
   </div>
  </div>
  <div class="col-lg-4"></div>
