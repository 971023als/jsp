...
<body>
  	<nav class="navbar navbar-default">
    	...
    	<ul class="nav navbar-nav navbar-right">
    	 ...
    	 <ul class="dropdown-menu">
  			...
  			aria-expanded="false">회원가입 완료<span class="caret"></span></a>
   		<ul class= "dropdown-menu">
 ...
 <div>
    ...
    <form name="loginForm" method="post" action="./joinAction.jsp">
     <h3 style="text-align: center;">입력 결과</h3>
    ...
    <input type="button" class="btn btn-primary form-control" value="뒤로 가기" OnClick="location='join.jsp'">
  </section>
 </div>
