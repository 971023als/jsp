...
<div class="main">
	<div class="main-explain">
		<div class="main-explain-text">
			<ul>
				<li class="head">불면증이란?</li>
				<li class="mainContents">
					<p>불면증은 전체 인구의 <span style ="color: red; ">30% 정도가</span> 경험하는 매우 흔한 질환이며 </p>
					<p>3개월 이상 증상이 만성적으로 지속되고 </p>
					<p>이로 인해 낮 동안 피로감, 집중력장애, 감정적인 변화 등 </p>
					<p>활동에 지장을 경험하는 경우는 전 인구 <span style ="color: red; "> 10%</span> 정도입니다.</p>
				</li>
				<li style="text-decoration-line:none;"><a class="insomnia" href="https://www.sleepmed.or.kr/content/info/insomnia.html">자세히 알아보기</a></li>
			</ul>
		</div>
	</div>
	<div class="main-explain">
		<div class="main-explain-text">
			<ul>
				<li class="head" style="margin-bottom: 5px;">자세한 내용</li>
				<li class="mainContents">
					<p>우리는 일시적인 스트테스나 기분의 변화로 인해 잠이 오지 않는 일을 경험하지만, </p>
					<p>불면증상이 반복되면 주의를 기울여 증상이 악회되지 않도록 해야 합니다.</p>
					<p>불면증상이 반복되면 주의를 기울여 증상이 악회되지 않도록 해야 합니다.</p>
					<p>보통 이러한 불면증상을 일주일에 3차례 이상 경험하거나 </p>
					<p>불면으로 인해 낮 동안의 생활에 방해가 심해진다면, </p>
					<p>가까운 병원이나 의원에 내원하여 본인의 증상을 이야기 하길 바랍니다.</p>
					<p>좌측 상단의 자가진단을 click하셔서 진단해 보세요</p>
				</li>
			</ul>
		</div>
	</div>
